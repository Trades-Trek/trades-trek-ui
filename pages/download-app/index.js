...
const DownloadApp = () => {
  const APKUrl =
    "https://play.google.com/store/apps/details?id=com.tradestrek.tradestrek";
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-y-7 md:flex-row bg-palette-one gap-x-14 h-screen">
      ...
      <h2 className="font-bold text-[32px] text-center md:text-left mb-2 pt-12 md:pt-0 text-[#8000ff] text-center">
          Congratulations
        </h2>
        <p className=" mb-8 text-lg font-light text-center md:text-left leading-[25px] text-[#8000ff]">
          Your Trades Trek account has been successfully created.
        </p>
        <br />
