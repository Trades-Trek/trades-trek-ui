const Terms = () => (
  <>
    <div data-custom-class="body bg-stone-50" className="m-5 p-5 bg-stone-50">
      <div align="center" style={{ textAlign: "center" }}>
        <div
          className="MsoNormal"
          data-custom-class="title"
          style={{ lineHeight: "1.5", padding: "15px" }}
        >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <bdt className="question">Nigeria</bdt>
                      <bdt className="statement-end-if-in-editor">
                        <span
                          style={{
                            fontSize: "11.0pt",
                  ...
                  at <bdt className="question">4 Oladeinde Street</bdt>
                  <bdt className="block-component" />
                </span>
              </span>
              , <bdt className="question">Anthony Village</bdt>
            </span>
          </span>
              ...
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="body_text">
                  <span style={{ color: "rgb(89, 89, 89)" }}>
                    <bdt className="block-component" />,{" "}
                    <bdt className="question">Lagos</bdt>
                    <bdt className="statement-end-if-in-editor" />
                    <bdt className="block-component" />{" "}
                    <bdt className="question">105102</bdt>
                    <bdt className="statement-end-if-in-editor" />
                  </span>
                </span>
              </span>
      ...
      <div align="center" style={{ textAlign: "left" }}>
        ...
        >
          <bdt className="question">
            Learn about stocks, markets, and more with our engaging app.
            Practice trading with virtual money, join competitions and stay
            informed with real-time market data.
          </bdt>
        </div>
        <div
          className="MsoNormal"
        ...
        >
          ...
          >
            ...
            phone at <bdt className="question">(+234)09129095967</bdt>, email at{" "}
            <bdt className="question">contactus@tradestrek.com</bdt>
            <bdt className="block-component" />,
            <bdt className="statement-end-if-in-editor" /> or by mail to{" "}
            <bdt className="question">4 Oladeinde Street</bdt>
            <bdt className="block-component" />,{" "}
            <bdt className="question">Anthony Village</bdt>
            <bdt className="block-component" />,{" "}
            <bdt className="question">Lagos</bdt>
        ...
        >
          ...
          >
            ...
            ), and <bdt className="question">Trades Trek Limited</bdt>,
        ...
        >
          ...
          >
            ...
            <bdt className="question">contactus@tradestrek.com</bdt>, as stated
      ...
      <div align="center" style={{ textAlign: "left" }}>
        ...
        >
          ...
          >
            ...
            <bdt className="question">contactus@tradestrek.com</bdt>. If we ever
      ...
      <div align="center" style={{ textAlign: "left" }}>
              ...
              <div className="MsoNormal" style={{ lineHeight: "1.1" }}>
                ...
                <ul>
                  {[
                    ...
                    "\nUpload or transmit (or attempt to upload or to tr…re' or 'passive collection mechanisms' or 'pcms')",
                    "\nInterfere with, disrupt, or create an undue burde…he networks or services connected to the Services",
                    "\nHarass, annoy, intimidate, or threaten any of employees or agents engaged in providing any portion of the Services to you",
                    "\nAttempt to bypass any measures of the Services desgned to the Services, or any portion of the Services",
                    "\nCopy or adapt the Services' software, including  but not limited to Flash, PHP, HTML, JavaScript, or other code",
                    "\nExcept as permitted by applicable law, decipher, …ng or in any way making up a part of the Services",
                    "\nExcept as may be the result of standard search en… launch any unauthorised script or other software",
        ...
        >
          ...
          >
            ...
            . <bdt className="question">Trades Trek Limited</bdt> and yourself
        ...
        >
          ...
          be <bdt className="question">three (3)</bdt>. The seat, or legal
        ...
        >
          <span style={{ fontSize: 15 }}>
            <span style={{ color: "rgb(89, 89, 89)" }}>
              <bdt className="question">
                <strong>Trades Trek Limited</strong>
              </bdt>
              <strong>
                <bdt className="block-component" />
              </strong>
        ...
        >
          <strong>
            ...
            >
              <strong>
                <bdt className="block-component" />
                Phone: <bdt className="question">(+234)09129095967</bdt>
                <bdt className="statement-end-if-in-editor" />
              </strong>
            </span>
          </strong>
